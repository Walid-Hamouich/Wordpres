	                ...
	                <div class="spnc-post-wrapper">
	                    ...
	                    <div class="spnc-entry-content">
	                        <div class="spnc-footer-meta">
	                            ...
	                            $read_more = get_theme_mod('newscrunch_blog_archive_read_btn', __('Read More','newscrunch'));?>
	                            <a itemprop="url" href="<?php echo esc_url(get_the_permalink());?>" class="spnc-more-link" title="<?php echo esc_attr($read_more);?>"><?php echo esc_html($read_more);?></a>
	                        	<?php endif;?>
	                        </div>
	                    </div>
	                </div>
