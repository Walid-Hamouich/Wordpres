    ...
    class Newscrunch_Preloader_Customize_Control extends WP_Customize_Control {
            public function render_content() { ?>
                <div class="newscrunch-premium">
                    ...
                    <a target="_blank" href="<?php echo esc_url('https://helpdoc.spicethemes.com/newscrunch/global-options/#preloader?ref=customizer'); ?>" class=" button-primary"><?php echo esc_html( 'Learn More'); ?></a>
                </div>
            <?php }
        }
        ...
        * Link color settings
        ...
        class Newscrunch_ThemeColor_Customize_Control extends WP_Customize_Control {
            public function render_content() { ?>
                <div class="newscrunch-premium">
                    <h3><?php echo esc_html('Unlock more features available in Pro version.'); ?></h3>
                    <a target="_blank" href="<?php echo esc_url('https://helpdoc.spicethemes.com/newscrunch/colors-typography/#theme-color?ref=customizer'); ?>" class=" button-primary"><?php echo esc_html( 'Learn More'); ?></a>
                </div>
            <?php }
        }
