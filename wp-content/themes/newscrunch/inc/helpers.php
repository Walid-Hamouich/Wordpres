...
function newscrunch_get_the_title($post_id) {
     echo '<a class="'.esc_attr(get_theme_mod('link_animate','a_effect1')).'" href="'.esc_url(get_permalink($post_id)).'" title="'.esc_html(get_the_title($post_id)).'">'.esc_html(get_the_title($post_id)).'</a>';
}
